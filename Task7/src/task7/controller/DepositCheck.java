	...
	public String perform(HttpServletRequest request) {
		...
		try {
		    ...
		    if (form.getButton() == null || form.getButton().equals("search")) {
		    	if (form.getCustomerEmail() != null && !form.getCustomerEmail().equals("")) {
			    	CustomerBean customerBean = null;
			    	if (customerDAO.getCustomerByEmail(form.getCustomerEmail()) != null) {
			    			customerBean = customerDAO.getCustomerByEmail(form.getCustomerEmail());
			    	}
			    	...
			    	customerListBean[0].setCustomerEmail(customerBean.getEmail());;
			    	customerListBean[0].setFirstName(customerBean.getFirstName());
					...
					for (int i = 0; i < customerBeans.length; i++) {
						...
						customerListBean[i].setCustomerEmail(customerBeans[i].getEmail());;
						customerListBean[i].setFirstName(customerBeans[i].getFirstName());
						customerListBean[i].setLastName(customerBeans[i].getLastName());
					}
			    ...
			    transactionBean.setTransactionType("Deposit (pending)");
