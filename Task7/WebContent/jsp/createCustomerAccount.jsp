...
<div class="container">
	...
	<form class="form-signin" method="post"
		action="createCustomerAccount.do">
		<c:choose>
		...
		<c:choose>
			...
			<c:otherwise>
				<input type="text" class="form-control" placeholder="Address1"
					value="${form.addr1}" required name="addr1">
			</c:otherwise>
		</c:choose>
		<c:choose>
		...
		<c:choose>
			...
			<c:otherwise>
				<input type="text" class="form-control" placeholder="City"
					value="${form.city}" required name="city">
			</c:otherwise>
		</c:choose>
		<c:choose>
			...
			<c:otherwise>
				<input type="text" class="form-control" placeholder="State"
					value="${form.state}" required name="state">
			</c:otherwise>
		</c:choose>
		<c:choose>
