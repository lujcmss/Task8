...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <form class="navbar-form navbar-center" method="post"  action="depositCheck.do">
		<div class="form-group">
    		<input type="text" class="form-control" placeholder="Customer Email" name="customerEmail">
  		</div>
        ...
        <tbody>
			<c:forEach var="customerList" items="${customerList}">
				...
				<form class="form-signin" method="post" action="depositCheck.do">
            		...
            		<td><button class="btn btn-primary" type="submit" name="button" value="deposit">Deposit</button></td>
            	</form>
	        	</tr>
			</c:forEach>
        </tbody>
