...
<div class="container">
	...
	<div class="bs-example bs-example-tabs">
		<ul id="myTab" class="nav nav-tabs">
			...
			<li><a href="#transaction" data-toggle="tab">Transaction
					History</a></li>
		</ul>
				...
				<div class="tab-pane fade in active" id="account">
					<table class="table table-striped">
						...
						<tbody>
							...
							<tr>
								<th>Address</th>
								<td><c:out value="${userInfo.addr1}" />,&nbsp;<c:out
										value="${userInfo.addr2}" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>$<fmt:formatNumber type="number" maxFractionDigits="2"
										minFractionDigits="2" value="${userInfo.cash/100.0}" /></td>
							</tr>
						</tbody>
					</table>
									...
									<c:choose>
										...
										<c:otherwise>
											<td>$<fmt:formatNumber type="number"
													...
													value="${historyInfo.sharePrice}" /></td>
										</c:otherwise>
									</c:choose>
									<c:choose>
