        ...
        <div class="navbar-collapse collapse">
            ...
            <!-- customer -->
             ...
             <c:when test="${userType=='Customer'}">
            	...
            	<c:choose>
            		<c:when test="${curPage=='home.do'}"> <li class="active"> </c:when>
            		<c:otherwise> <li> </c:otherwise>
            	</c:choose>
            		<a href="home.do">Home</a></li>
            
            	<c:choose>
            		<c:when test="${curPage=='funds.do'}"> <li class="active" class="dropdown"> </c:when>
           		...
           		<c:choose>
            		<c:when test="${curPage=='requestCheck.do'}"> <li class="active"> </c:when>
            		<c:otherwise> <li> </c:otherwise>
            	</c:choose>
            		<a href="requestCheck.do">Request Check</a></li>

				<c:choose>
            		<c:when test="${curPage=='transactionHistory.do'}"> <li class="active"> </c:when>
            		<c:otherwise> <li> </c:otherwise>
            	</c:choose>            		
            		<a href="transactionHistory.do">Transaction History</a></li>
            	</ul>
            	
	          	<ul class="nav navbar-nav navbar-right">
	            	<li><a>Hi, ${user.firstName}.  Available Cash: $<fmt:formatNumber type="number" 
            ...
            <ul class="nav navbar-nav">
            	...
            	<c:choose>
            		<c:when test="${curPage=='manageAccount.do'}"> <li class="active" class="dropdown"> </c:when>
            		<c:otherwise> <li class="dropdown"> </c:otherwise>
            	</c:choose>
            	...
            	<c:choose>
            		<c:when test="${curPage=='depositCheck.do'}"> <li class="active"> </c:when>
            		<c:otherwise> <li> </c:otherwise>
            	</c:choose>
            		<a href="depositCheck.do">Deposit Check</a></li>
            		
            	<c:choose>
            		<c:when test="${curPage=='createFund.do'}"> <li class="active"> </c:when>
            		<c:otherwise> <li> </c:otherwise>
            	</c:choose>
            		<a href="createFund.do">Create Fund</a></li>
            	
            	<c:choose>
            		<c:when test="${curPage=='transitionDay.do'}"> <li class="active"> </c:when>
            		<c:otherwise> <li> </c:otherwise>
            	</c:choose>
            		<a href="transitionDay.do">Transition Day</a></li>
            	</ul>
