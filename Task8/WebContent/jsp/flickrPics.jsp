...
<script>
	...
	function imageFunction(tags2) {
		...
		var url = flickrServiceURL
				...
				+ tags
				+ "&per_page=30"
				+ "&sort=interestingness-desc&extras=tags%2Cviews%2Curl_l%2Cdescription&format=json&nojsoncallback=1";
								...
								$("#filter-container")
										.append(
												"<figure class=web>"
														...
														+ "		</fieldset>"
														+ "		<button type=submit name=button value=Comment alt=share><img src=/Task8/img/social/twitter_bird.png></button>"
														+ "		<button type=submit name=button alt=Like value=Like><img src=/Task8/img/social/heart.png></button>"
														+ "		<button type=submit name=button alt =Dislike value=Dislike><img src=/Task8/img/social/feed_burner.png></button>"
														+ "		</form>"
														+ "		</div>"
														+ "</figcaption>"
...
window.onload = imageFunction(document.getElementById("tags").value);
</script>