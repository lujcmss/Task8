...
<br>
	<button class="link-button green" type="submit" name="button" value="mostComment">Top Comments</button>
	<button class="link-button blue" type="submit" name="button" value="mostLike">Like
	</button>
	<button class="link-button red" type="submit" name="button" value="mostDislike">Disliked</button>
</form>
					...
					<figcaption>
						...
						<div id="dialog-form" >
							...
							<form method="post" action="commentHistory.do">
								...
								<button class="link-button green" type="submit" name="button" value="Comment">
									<img src="/Task8/img/social/twitter_bird.png">
								</button>
								<button class="link-button blue" id="like" name="button" value="Like">
									<img src="/Task8/img/social/heart.png">
								</button>
								<button class="link-button red" id="dislike" name="button" value="Dislike">
